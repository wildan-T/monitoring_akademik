...
final tugasList = [tugas1, tugas2, tugas3, tugas4].where((t) => t != null).toList();
final rataTugas = tugasList.isNotEmpty
? tugasList.reduce((a, b) => a! + b!)! / tugasList.length
: null;
final uhList = [uh1, uh2].where((u) => u != null).toList();
final rataUH = uhList.isNotEmpty 
...
final scores = [tugas1, tugas2, tugas3, tugas4]
.where((s) => s != null)
.toList();
if (scores.isEmpty) return null;
return scores.reduce((a, b) => a! + b!) / scores.length;
}
// Rata-rata UH (uh1 + uh2) / 2
double? get nilaiUH {
final scores = [uh1, uh2].where((s) => s != null).toList();
if (scores.isEmpty) return null;
return scores.reduce((a, b) => a! + b!) / scores.length;
}
// Alias untuk UTS
...
return NilaiModel(
  ...
  tugas1: json['tugas1'] != null ? double.tryParse(json['tugas1'].toString()) : null,
  tugas2: json['tugas2'] != null ? double.tryParse(json['tugas2'].toString()) : null,
  tugas3: json['tugas3'] != null ? double.tryParse(json['tugas3'].toString()) : null,
  tugas4: json['tugas4'] != null ? double.tryParse(json['tugas4'].toString()) : null,
