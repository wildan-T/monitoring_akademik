...
class LengkapiProfilGuruScreen extends StatefulWidget {
  ...
  @override
  State<LengkapiProfilGuruScreen> createState() => _LengkapiProfilGuruScreenState();
}
...
class _LengkapiProfilGuruScreenState extends State<LengkapiProfilGuruScreen> {
  ...
  Future<void> _submit() async {
    ...
    if (success && mounted) {
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(
          content: Text(guruProvider.error ?? '❌ Gagal melengkapi profil'),
          backgroundColor: Colors.red,
        ),
      );
    }
              ...
              child: ListView(
                ...
                children: [
                  ...
                  DropdownButtonFormField<String>(
                    ...
                    items: _jenisKelaminOptions.map((jk) {
